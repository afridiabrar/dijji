                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.site-settings.update', $records->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="contact_email" maxlength="190"
                                    value="{{ old('contact_email', $records->contact_email) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="contact_phone" maxlength="190"
                                    value="{{ old('contact_phone', $records->contact_phone) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="twitter" maxlength="190"
                                    value="{{ old('twitter', $records->twitter) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="youtube" maxlength="190"
                                    value="{{ old('youtube', $records->youtube) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="linkedin" class="col-md-2 control-label">Linkedin URL</label>
                            <div class="col-md-4">
                                <input type="text" name="linkedin" maxlength="190"
                                    value="{{ old('linkedin', $records->linkedin) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="youtube" class="col-md-2 control-label">Playstore Link</label>
                            <div class="col-md-4">
                                <input type="text" name="playstore_link" maxlength="190"
                                    value="{{ old('playstore_link', $records->playstore_link) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="linkedin" class="col-md-2 control-label">AppsStore Link</label>
                            <div class="col-md-4">
                                <input type="text" name="appstore_link" maxlength="190"
                                    value="{{ old('linkedin', $records->appstore_link) }}" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                @if ($records->logo != '' && file_exists(uploadsDir() . $records->logo))
                                    <img src="{!! asset('uploads/' . $records->logo) !!}" alt="" title="Logo"
