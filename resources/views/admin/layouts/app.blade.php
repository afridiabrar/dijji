...
<head>
    ...
    <title>{{ ucfirst($pageTitle) }} | Admin</title>
    ...
    <link href="{{ asset('assets/admin/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <link href="{{ asset('assets/admin/css/themes/default.css') }}" rel="stylesheet" type="text/css"
        id="style_color" />
...
<body class="page-header-fixed">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn blue" id="deleteButton"
    ...
    <div class="footer">
        <div class="footer-inner">
            {{-- {!! \Carbon\Carbon::now()->format('Y') !!} &copy; Copyright by {!! config('app.name') !!}. --}}
            {{ $setting->copyright }}.
    ...
    <script src="{{ asset('assets/admin/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}" type="text/javascript">
    </script>
