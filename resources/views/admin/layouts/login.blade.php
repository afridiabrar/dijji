...
<body class="login">
    ...
    <div class="logo text-align-left">
        <a href="{{ route('admin.') }}">
            ...
            @else
                <img src="{!! asset('logo.png') !!}" alt="Web Builder" class="img-responsive"
                    style="margin:0 auto; width:150px;" />
            @endif
        </a>
    </div>
    ...
    <script src="{{ asset('assets/admin/plugins/jquery-validation/dist/jquery.validate.min.js') }}" type="text/javascript">
    </script>
