...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.benefits.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.benefits.store') }}" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="detail" class="form-control ckeditor" maxlength="65000">{{ old('detail') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="category">
                                    ...
                                    <option value="1" {{ old('1') }}>Retailer
                                    </option>
                                    <option value="0" {{ old('0') }}>Customer
                                    </option>
                                </select>                            </div>
                        </div>
                        <div class="form-group">
