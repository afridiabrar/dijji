...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.teams.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.teams.create') !!}" id="sample_editable_1_new" class="btn blue">
                        ...
                        <tbody>
                            @foreach ($records as $key => $record)
                                <tr class="odd gradeX">
                                    ...
                                    @if ($record->media != '' && file_exists(uploadsDir('teams/') . $record->media))
                                        <td><img src="{!! asset('uploads/teams/' . $record->media) !!}" alt="{!! $record->title !!}"
                                    ...
                                    <td class="center text-center">
                                        <a href="{!! URL::route('admin.teams.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a>
                                        <a href="{!! URL::route('admin.teams.edit', $record->id) !!}" class="btn btn-xs green" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        {{-- @if (in_array($record->id, $restrictedTeams)) --}}
                                        ...
                                        {{-- @endif --}}
                                        <form action="{!! URL::route('admin.teams.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script src="{!! URL::to('assets/admin/scripts/custom/teams.js') !!}"></script>
    <script>
