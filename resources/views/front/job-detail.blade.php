                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fname" pattern="[A-Za-z]{1,32}}" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lname" pattern="[A-Za-z]{1,32}" class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Julia"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" id="exampleFormControlTextarea1"
                                        rows="3" placeholder="Type here" style="height: 60px;" required></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row align-items-center">
                                    <div class=" col-md-6 col-xs-6">
                                        ...
                                        <div>
                                            ...
                                            <label for="actual-btn" class="choosenfile">Choose File</label>
