                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-investor-tab" data-toggle="pill" href="#pills-investor"
                                role="tab" aria-controls="pills-investor" aria-selected="true">Login as a Investors</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tester-tab" data-toggle="pill" href="#pills-tester" role="tab"
                                aria-controls="pills-tester" aria-selected="false">Login as a Beta testers</a>
                        </li>
                    </ul>
